...
def category_wise_report(
    ...
    return get_category_wise_report(db=db, current_user=current_user)
...
def monthly_report(
    ...
    return get_monthly_report(db=db, current_user=current_user)
...
def top_categories_report(
    ...
    return get_top_categories(db=db, current_user=current_user)
